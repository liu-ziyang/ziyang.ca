...
export default function Home() {
  ...
  return (
    <>
      <main className="min-h-screen flex flex-col items-center justify-center p-4 bg-linear-to-br from-white to-gray-100 dark:from-gray-900 dark:to-black transition-all">
        ...
        {showResume && (
          ...
          >
            <div className="relative bg-white dark:bg-neutral-900 rounded-lg shadow-xl w-[90vw] max-w-2xl h-[90vh] flex flex-col">
              <iframe
                src="/resume.pdf"
                title="Resume PDF"
...
function LinkCard({ href, title, description, onClick }: LinkCardProps) {
  const className =
    "group border rounded-xl px-3 py-3 sm:px-6 sm:py-5 lg:px-8 lg:py-6 max-w-xs w-full mx-auto transition-all hover:shadow-md hover:border-gray-300 hover:bg-white dark:hover:border-neutral-700 dark:hover:bg-neutral-800/30";
  return (
    <a
      href={href}
      target="_blank"
